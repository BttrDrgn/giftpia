...
blacklistedInsns = {
    ...
    PPC_INS_VMRGHB, PPC_INS_XXSPLTW, PPC_INS_XSMSUBADP, PPC_INS_VPKUHUM, PPC_INS_XSMADDMDP,
    PPC_INS_XSMADDADP, PPC_INS_VMSUMUBM, PPC_INS_XSCMPUDP, PPC_INS_XSCMPODP,
